// Sensor card that also navigates to a subpage when tapped.
registerButtonType("sensor_subpage", {
  label: "Sensor + Subpage",
  ...
  renderPreview: function (b, helpers) {
    var chevron = '<span class="sp-subpage-badge mdi mdi-chevron-right"></span>';
    if (b.precision === "text") {
      ...
      return {
        ...
        labelHtml:
          ...
          '<span class="sp-btn-label-row" style="justify-content:flex-end">' + chevron + '</span>',
      };
    }
